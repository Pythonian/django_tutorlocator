    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro_video', models.FileField(blank=True, null=True, upload_to='intros')),
                ('academic_qualification', models.CharField(blank=True, max_length=50, null=True)),
                ('private_tutoring', models.BooleanField()),
                ('tutoring_experience', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('user', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tutor', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Student',
